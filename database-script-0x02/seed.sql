...
INSERT INTO Property (property_id, host_id, name, description, pricepernight, created_at, updated_at) VALUES
  ('1', '2', 'Cozy Cabin', 'A warm, wooden cabin in the mountains.', 150.00, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('2', '2', 'Beach House', 'A beach-side home with ocean view.', 250.00, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO Review (review_id, property_id, user_id, rating, comment, created_at) VALUES
  ...
  ('5', '2', '1', 4, 'Nice beach view but too noisy at night.', CURRENT_TIMESTAMP);

-- Sample Messages
INSERT INTO Message (message_id, sender_id, recipient_id, message_body, sent_at) VALUES
  (6, 1, 2, 'Hi, is the cabin available for July?', CURRENT_TIMESTAMP),
  (7, 2, 1, 'Yes, it''s available. Let me know the dates.', CURRENT_TIMESTAMP);
